namespace Core
{
    public static class SqlNative
    {
        ...
        public static string SQL_GET_ITEMEX_BY_ID = "select id, type from cq_itemex where id = {0} or id = {1};";
        public static string SQL_DELETE_ITEMEX_BY_ID = "delete from cq_itemex where id = {0};";
    }
}
